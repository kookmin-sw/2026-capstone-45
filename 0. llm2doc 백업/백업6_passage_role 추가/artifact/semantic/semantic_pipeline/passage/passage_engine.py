...
For each passage, also produce passage_role.
passage_role describes the reusable document function of the passage.
It must be topic-agnostic but format/function-specific.
Do not include specific company names, product names, business names, years, scores, metrics, numbers, or source names unless they are necessary to describe the generic document function.
                ...
                "passages": [
                    {
                        ...
                        "passage_role": "topic-agnostic reusable document function of this passage",
                    }
                ],
